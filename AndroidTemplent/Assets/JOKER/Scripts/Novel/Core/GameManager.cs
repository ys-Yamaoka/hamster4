...
namespace Novel
{
	...
	public class GameManager
	{
		...
		public void loadData(string data_name){
            ...
            NovelSingleton.GameView.messageAreaPlayer.GetComponent<Text>().text = sobj.currentMessage;
            ...
            if (StatusManager.currentTextColor != "") {
                ...
                NovelSingleton.GameView.messageAreaPlayer.GetComponent<Text>().color = ColorX.HexToRGB(StatusManager.currentTextColor);
