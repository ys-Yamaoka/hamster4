	...
	public class FontComponent:AbstractComponent
	{
		...
		public override void start ()
		{
            ...
            if (this.param ["size"] != "") {
                ...
                this.gameView.messageAreaPlayer.GetComponent<Text>().fontSize = size;
            ...
            if (this.param ["color"] != "") {
                ...
                this.gameView.messageAreaPlayer.GetComponent<Text>().color = ColorX.HexToRGB(color);
 ...
 */
	public class FontresetComponent:AbstractComponent
	{
		...
		public override void start ()
		{
            ...
            this.gameView.messageAreaPlayer.GetComponent<Text>().color = ColorX.HexToRGB(this.gameManager.getConfig("messageFontColor")); ;
