 ...
 */
     ...
     */
    //IComponentTextはテキストを流すための機能を保持するためのインターフェース
    public class StoryenemyComponent : AbstractComponent
    {
        public StoryenemyComponent()
        {
        ...
        public override void start()
        {
            ...
            string message2 = this.param["hamu"];

            StatusManager.enableNextOrder = false;

            this.gameManager.scene.coroutineShowMessage2(message2);
 ...
 */
    //IComponentTextはテキストを流すための機能を保持するためのインターフェース
    public class MessageframefrontComponent : AbstractComponent
    {
        private int num;
        public MessageframefrontComponent()
        {
        ...
        public override void start()
        {
            GameObject.Find("MessageFrame").transform.SetAsLastSibling();
        }
    }
...
*/
    //IComponentTextはテキストを流すための機能を保持するためのインターフェース
    public class MessageframebackComponent : AbstractComponent
    {
        private int num;
        public MessageframebackComponent()
        {
        ...
        public override void start()
        {           
                GameObject.Find("MessageFramePlayer").transform.SetAsLastSibling();     
        }
    }
 ...
 */
	...
	public class CmComponent:AbstractComponent
	{
		...
		public override void start ()
		{
			...
			StatusManager.enableNextOrder = true;
			this.gameManager.scene.clearCurrentMessage ();
			this.gameView.messageAreaPlayer.text = "";
